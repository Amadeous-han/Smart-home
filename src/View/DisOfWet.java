...
public class DisOfWet {
	JFrame frame = new JFrame("disofwet");
	...
	public void setbuttonSearch() {
		...
		buttonSearch.addActionListener(new ActionListener() {
			...
			int[] num;
			try {
				num = dataAction.getDisOfWet(startTime, finishTime);
				JDialog jd=new JDialog();
				jd.setBounds(400, 170, 600, 600);
				jd.add(new DisOfWet(num).getPanel());
				jd.setVisible(true);		
