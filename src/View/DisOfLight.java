...
public class DisOfLight {
	JFrame frame = new JFrame("disofLight");
	...
	public static CategoryDataset getDataSet(int[] num) {
		 ...
		 data.setValue(num[0], "", "0-300");
		 data.setValue(num[1], "", "301-600");
		 data.setValue(num[2], "", "601-1000");
		 return data;
	}
	//4-返回一个ChartPanel
	...
	public void setbuttonSearch() {
		...
		buttonSearch.addActionListener(new ActionListener() {
			...
			int[] num;
			try {
				num = dataAction.getDisOfLight(startTime, finishTime);
				JDialog jd=new JDialog();
				jd.setBounds(400, 170, 600, 600);
				jd.add(new DisOfLight(num).getPanel());
				jd.setVisible(true);		
