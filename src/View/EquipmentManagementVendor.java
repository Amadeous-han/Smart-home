...
public class EquipmentManagementVendor {
	...
	// 表格
			...
			public EquipmentManagementVendor(String VId) {
...
//						}
			...
			private void setTable(String VId) {
				...
				try {
					...
					Object[][] tar = equipmentAction.findTable(results,VId);
					table = new JTable(tar,columnNames);
